...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/19 22:56:47 by emorshhe          #+#    #+#             */
/*   Updated: 2025/02/19 23:03:03 by emorshhe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int					ft_input_redir(char *fname, t_fd *fd_info,
								int op, t_shell *shell);
static int					ft_output_redir(char *fname, t_fd *fd_info,
								int op, t_shell *shell);
